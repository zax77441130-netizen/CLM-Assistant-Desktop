  ...
  it("accepts the complete explicit bridge surface", () => {
    Object.defineProperty(window, "clmAssistant", {
      ...
      value: {
        ...
        getWorkspaces: async () => [],
        getEngineeringProjectContext: async () => ({ workspaceId: "workspace", projectName: "Project", stacks: [], markers: [], entrypoints: [], testCommands: [], buildCommands: [], testReadiness: { commandId: "test", status: "NO_SCRIPT", reasonCode: "ENGINEERING_COMMAND_UNAVAILABLE", reason: "沒有測試腳本", candidateCount: 0 }, buildReadiness: { commandId: "build", status: "NO_SCRIPT", reasonCode: "ENGINEERING_COMMAND_UNAVAILABLE", reason: "沒有建置腳本", candidateCount: 0 }, git: { detected: false }, scan: { fileCount: 0, directoryCount: 0, truncated: false, maxDepth: 8 } }),
