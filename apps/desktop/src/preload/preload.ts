...
const api = {
  ...
  getEngineeringProjectContext: (workspaceId: string) => ipcRenderer.invoke(DESKTOP_API_CONTRACT.getEngineeringProjectContext, workspaceId),
  runEngineeringCommand: (workspaceId: string, commandId: "test" | "build") => ipcRenderer.invoke(DESKTOP_API_CONTRACT.runEngineeringCommand, { workspaceId, commandId }),
